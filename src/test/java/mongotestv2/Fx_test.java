...
public class Fx_test {
	...
	public static void main(String[] args) throws Exception {
		...
		// printwriter
		PrintWriter p = new PrintWriter("/home/ec2-user/hbase_mongo_test/FX.csv");
		...
		for (int i = 0; i < num_of_update; i++) {
			...
			UpdateResult t = collection.updateMany(new Document("LocalCurrencyCode", factory.getRandomFx()),
					new Document("$set", new Document("FXRateBase", random.get())));
			...
			System.out.println("cycle Count [FX]:"+i);
		}
