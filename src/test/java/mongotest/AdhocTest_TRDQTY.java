...
public class AdhocTest_TRDQTY {
	public static void main(String[] args) throws Exception {
		...
		// declaring stopwatch
		StopWatch watch = new StopWatch(true, "/home/ec2-user/hbase_mongo_test/result_text/TRDQTY.txt");
		...
		for (int i = 0; i < num_of_update; i++) {
			...
			match.put("PositionKey", factory.getRandomPosition());

			ArrayList<HashMap<String, Object>> t = crud.getDocs("nezu_data_db", "nezu_position_denorm_data_coll_new", match);

			// doing expensive operations

			int currentQTY = random.get();
			for (HashMap<String, Object> temp : t) {

				HashMap<String, Object> temp1 = new HashMap<String, Object>(temp);

				temp1.put("TradeQuantity", currentQTY);
		...
		watch.genrateChart("test", "/home/ec2-user/hbase_mongo_test/result_visual/TRDQTY.jpeg", 640, 480, "Quantity Change", "Update_Count",
				"Time (Nano sec)");
